...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, image, platforms, pos, *groups):
        ...
        self.jump_amount = 12 #10  # jump strength
...
# mappa finale primo livello END posizionato meglio 
# conteggio dei coins va rivisto 
# flow delle immagini migliorato
# secondo livello , I primo coin è impossibil da prendere 
# schermata di vittoria ridimensionare e abbellire 
