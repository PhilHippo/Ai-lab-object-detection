...
#run "C:\Users\wangf\Myrepos\AI_PROJECT_STUFF\opencv\build\x64\vc15\bin\opencv_createsamples.exe -info pos.txt -w 18 -h 49 -num 3000 -vec pos.vec"

#finally we train the model and save it in the cascade folder
#run "C:\Users\wangf\Myrepos\AI_PROJECT_STUFF\opencv\build\x64\vc15\bin\opencv_traincascade.exe -data cascade/ -vec pos.vec -bg neg.txt -w 18 -h 49  -numPos 680 -numNeg 340 -numStages 10 -acceptanceRatioBreakValue 0.0001 -mode ALL"